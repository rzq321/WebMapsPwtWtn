...
var format_IRIGASI_LN_25K_0 = new ol.format.GeoJSON();
var features_IRIGASI_LN_25K_0 = format_IRIGASI_LN_25K_0.readFeatures(json_IRIGASI_LN_25K_0, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_IRIGASI_LN_25K_0 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_IRIGASI_LN_25K_0.addFeatures(features_IRIGASI_LN_25K_0);
var lyr_IRIGASI_LN_25K_0 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_IRIGASI_LN_25K_0, 
                style: style_IRIGASI_LN_25K_0,
                popuplayertitle: "IRIGASI_LN_25K",
                interactive: true,
                title: '<img src="styles/legend/IRIGASI_LN_25K_0.png" /> IRIGASI_LN_25K'
            });
...
var lyr_BatasRT_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/BatasRT_3_39.png" /> <br />\
    <img src="styles/legend/BatasRT_3_40.png" /> RT 001 / RW 011<br />'
        });
var format_Wilayah_Purwokerto_Wetan_poly_4 = new ol.format.GeoJSON();
var features_Wilayah_Purwokerto_Wetan_poly_4 = format_Wilayah_Purwokerto_Wetan_poly_4.readFeatures(json_Wilayah_Purwokerto_Wetan_poly_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Wilayah_Purwokerto_Wetan_poly_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Wilayah_Purwokerto_Wetan_poly_4.addFeatures(features_Wilayah_Purwokerto_Wetan_poly_4);
var lyr_Wilayah_Purwokerto_Wetan_poly_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Wilayah_Purwokerto_Wetan_poly_4, 
                style: style_Wilayah_Purwokerto_Wetan_poly_4,
                popuplayertitle: "Wilayah_Purwokerto_Wetan_poly",
                interactive: true,
                title: '<img src="styles/legend/Wilayah_Purwokerto_Wetan_poly_4.png" /> Wilayah_Purwokerto_Wetan_poly'
            });
var format_LAPANGNMARSPURWOKERTOWETAN_5 = new ol.format.GeoJSON();
var features_LAPANGNMARSPURWOKERTOWETAN_5 = format_LAPANGNMARSPURWOKERTOWETAN_5.readFeatures(json_LAPANGNMARSPURWOKERTOWETAN_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_LAPANGNMARSPURWOKERTOWETAN_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LAPANGNMARSPURWOKERTOWETAN_5.addFeatures(features_LAPANGNMARSPURWOKERTOWETAN_5);
var lyr_LAPANGNMARSPURWOKERTOWETAN_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LAPANGNMARSPURWOKERTOWETAN_5, 
                style: style_LAPANGNMARSPURWOKERTOWETAN_5,
                popuplayertitle: "LAPANGN MARS PURWOKERTO WETAN",
                interactive: true,
                title: '<img src="styles/legend/LAPANGNMARSPURWOKERTOWETAN_5.png" /> LAPANGN MARS PURWOKERTO WETAN'
            });
var format_LapanganSmeconne_6 = new ol.format.GeoJSON();
var features_LapanganSmeconne_6 = format_LapanganSmeconne_6.readFeatures(json_LapanganSmeconne_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_LapanganSmeconne_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LapanganSmeconne_6.addFeatures(features_LapanganSmeconne_6);
var lyr_LapanganSmeconne_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LapanganSmeconne_6, 
                style: style_LapanganSmeconne_6,
                popuplayertitle: "Lapangan Smeconne",
                interactive: true,
                title: '<img src="styles/legend/LapanganSmeconne_6.png" /> Lapangan Smeconne'
            });
...
var format_ALFAMART_8 = new ol.format.GeoJSON();
var features_ALFAMART_8 = format_ALFAMART_8.readFeatures(json_ALFAMART_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_ALFAMART_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ALFAMART_8.addFeatures(features_ALFAMART_8);
var lyr_ALFAMART_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ALFAMART_8, 
                style: style_ALFAMART_8,
                popuplayertitle: "ALFAMART",
                interactive: true,
                title: '<img src="styles/legend/ALFAMART_8.png" /> ALFAMART'
            });
var format_KLENTENGHOKTEHBIOPURWOKERTO_9 = new ol.format.GeoJSON();
var features_KLENTENGHOKTEHBIOPURWOKERTO_9 = format_KLENTENGHOKTEHBIOPURWOKERTO_9.readFeatures(json_KLENTENGHOKTEHBIOPURWOKERTO_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_KLENTENGHOKTEHBIOPURWOKERTO_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KLENTENGHOKTEHBIOPURWOKERTO_9.addFeatures(features_KLENTENGHOKTEHBIOPURWOKERTO_9);
var lyr_KLENTENGHOKTEHBIOPURWOKERTO_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_KLENTENGHOKTEHBIOPURWOKERTO_9, 
                style: style_KLENTENGHOKTEHBIOPURWOKERTO_9,
                popuplayertitle: "KLENTENG HOK TEH BIO PURWOKERTO",
                interactive: true,
                title: '<img src="styles/legend/KLENTENGHOKTEHBIOPURWOKERTO_9.png" /> KLENTENG HOK TEH BIO PURWOKERTO'
            });
...
var format_MasjiddiPwtWetan_11 = new ol.format.GeoJSON();
var features_MasjiddiPwtWetan_11 = format_MasjiddiPwtWetan_11.readFeatures(json_MasjiddiPwtWetan_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_MasjiddiPwtWetan_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MasjiddiPwtWetan_11.addFeatures(features_MasjiddiPwtWetan_11);
var lyr_MasjiddiPwtWetan_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MasjiddiPwtWetan_11, 
                style: style_MasjiddiPwtWetan_11,
                popuplayertitle: "Masjid di Pwt Wetan",
                interactive: true,
                title: '<img src="styles/legend/MasjiddiPwtWetan_11.png" /> Masjid di Pwt Wetan'
            });
...
lyr_IRIGASI_LN_25K_0.setVisible(true);lyr_LahanKosongGrahaTimur_1.setVisible(true);lyr_Kuburan_2.setVisible(true);lyr_BatasRT_3.setVisible(true);lyr_Wilayah_Purwokerto_Wetan_poly_4.setVisible(true);lyr_LAPANGNMARSPURWOKERTOWETAN_5.setVisible(true);lyr_LapanganSmeconne_6.setVisible(true);lyr_Jalan_7.setVisible(true);lyr_ALFAMART_8.setVisible(true);lyr_KLENTENGHOKTEHBIOPURWOKERTO_9.setVisible(true);lyr_PASARWAGEPURWOKERTO_10.setVisible(true);lyr_MasjiddiPwtWetan_11.setVisible(true);lyr_Rumahsakit_12.setVisible(true);lyr_RedDoorz_13.setVisible(true);lyr_GudangRitaRitelindo_14.setVisible(true);lyr_TEMPATMAKAN_15.setVisible(true);lyr_TPQBAITULHIKMAHPUROKWRTOWETAN_16.setVisible(true);lyr_Gereja_17.setVisible(true);lyr_BANK_18.setVisible(true);lyr_SEKOLAH_19.setVisible(true);lyr_PEMAKAMAN_20.setVisible(true);lyr_BrowniesAmandaPurwokwerto_21.setVisible(true);lyr_LapanganBola_22.setVisible(true);lyr_Perumahan_23.setVisible(true);lyr_RumahRizqi_24.setVisible(true);lyr_Wilayah_Purwokerto_Wetan_point_25.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_26.setVisible(true);
var layersList = [lyr_IRIGASI_LN_25K_0,lyr_LahanKosongGrahaTimur_1,lyr_Kuburan_2,lyr_BatasRT_3,lyr_Wilayah_Purwokerto_Wetan_poly_4,lyr_LAPANGNMARSPURWOKERTOWETAN_5,lyr_LapanganSmeconne_6,lyr_Jalan_7,lyr_ALFAMART_8,lyr_KLENTENGHOKTEHBIOPURWOKERTO_9,lyr_PASARWAGEPURWOKERTO_10,lyr_MasjiddiPwtWetan_11,lyr_Rumahsakit_12,lyr_RedDoorz_13,lyr_GudangRitaRitelindo_14,lyr_TEMPATMAKAN_15,lyr_TPQBAITULHIKMAHPUROKWRTOWETAN_16,lyr_Gereja_17,lyr_BANK_18,lyr_SEKOLAH_19,lyr_PEMAKAMAN_20,lyr_BrowniesAmandaPurwokwerto_21,lyr_LapanganBola_22,lyr_Perumahan_23,lyr_RumahRizqi_24,lyr_Wilayah_Purwokerto_Wetan_point_25,lyr_ADMINISTRASIDESA_AR_25K_26];
lyr_IRIGASI_LN_25K_0.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'REMARK': 'REMARK', 'FCODE': 'FCODE', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', 'SHAPE_Leng': 'SHAPE_Leng', });
...
lyr_IRIGASI_LN_25K_0.set('fieldImages', {'NAMOBJ': 'TextEdit', 'REMARK': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'SHAPE_Leng': 'TextEdit', });
...
lyr_IRIGASI_LN_25K_0.set('fieldLabels', {'NAMOBJ': 'no label', 'REMARK': 'no label', 'FCODE': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'SHAPE_Leng': 'no label', });
